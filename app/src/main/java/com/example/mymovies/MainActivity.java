...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switchSort = (Switch) findViewById(R.id.switchSort);
        textViewPopularity = (TextView) findViewById(R.id.textViewPopularity);
        textViewTopRated = (TextView) findViewById(R.id.textViewTopRaited);
        recyclerViewPosters = (RecyclerView) findViewById(R.id.recyclerViewPosters);
    ...
    public void onClickSetTopRaited(View view) {
    ...
    private void setMethodOfSort(boolean isTopRated) {
        ...
        if (isTopRated) {
            ...
            methodOfSort = NetworkUtils.TOP_RAITED;
        } else {
